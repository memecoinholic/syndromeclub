(() => {
      ...
      if (s)
        if (
          ...
          this.options.hashSettings.location &&
            ...
            this._reopen ? (this._reopen = !1) : !this.bodyLock && i(),
  ...
  class c {
    constructor(t) {
      t.length &&
        (this.elements = Array.from(t).map((t) => new c.Each(t, this.options)));
    }
    destroyEvents() {
  ...
  (c.Each = class {
    ...
    animationFrame() {
      const t = this.parent.getBoundingClientRect().top,
        ...
        o = t - s,
        i = t + e,
        n = this.parent.dataset.prlxCenter
    ...
    document.querySelectorAll("[data-prlx-parent]") &&
      (t.parallax = new c(document.querySelectorAll("[data-prlx-parent]")));
  let l = (t, e = !1, s = 500, o = 0) => {
  ...
  new (class {
      ...
      (this.оbjects = []),
        ...
        this.nodes.forEach((t) => {
          ...
          (s.element = t),
            ...
            (s.breakpoint = e[1] ? e[1].trim() : "767.98"),
    ...
    document.addEventListener("DOMContentLoaded", () => {
      function t() {
        const t = document.querySelector(".header__time");
        if (!t) return;
        const e = new Date(),
          s = String(e.getUTCHours()).padStart(2, "0"),
          o = String(e.getUTCMinutes()).padStart(2, "0"),
          i = String(e.getUTCSeconds()).padStart(2, "0");
        t.textContent = `${s}:${o}:${i} UT. MOON`;
      }
      t(), setInterval(t, 1e3);
    }),
    document.addEventListener("click", async function (t) {
      if (t.target.closest(".copy-ca-btn"))
        try {
          const e =
            t.target.closest(".copy-ca-btn").previousElementSibling.textContent;
        ...
        if ("click" === e.type) {
          ...
          if (s.closest("[data-goto]")) {
            const o = s.closest("[data-goto]"),
              ...
              c = o.dataset.gotoTop ? parseInt(o.dataset.gotoTop) : 0;
            if (t.fullpage) {
              const e = document
                  .querySelector(`${i}`)
